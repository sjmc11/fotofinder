<template lang="html">
    <div class="photo-element relative trans group">
        ...
        <button type="button" :class="isFav(photo.id) ? 'text-red-500' : 'hidden text-zinc-600 hover:text-zinc-900'" class="group-hover:inline-flex absolute top-4 right-4 w-7 h-7 rounded-full bg-neutral-50 z-10 items-center justify-center" @click="handleToggleFavourite(photo)" title="Add to favourites">♥</button>
    </div>
</template>
